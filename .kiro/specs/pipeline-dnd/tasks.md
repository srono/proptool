...
- [ ] 1. Install dependency and create utility modules
  - [ ] 1.1 Install @dnd-kit/core and create keyboard coordinate getter
  ...
  - [ ] 1.2 Create screen reader announcements module
...
- [ ] 2. Implement droppable and draggable wrapper components
  - [ ] 2.1 Create DroppableColumn component
  ...
  - [ ] 2.2 Create DraggableLeadCard component
...
- [ ] 3. Enhance PipelineBoard with DnD context and optimistic state
  - [ ] 3.1 Refactor PipelineBoard to use DndContext and local state
  ...
  - [ ] 3.2 Implement drag event handlers and DragOverlay
...
- [ ] 5. Property-based and unit tests
  - [ ]* 5.1 Write property test: Optimistic stage update (Property 1)
  ...
  - [ ]* 5.2 Write property test: No-op preservation (Property 2)
  ...
  - [ ]* 5.3 Write property test: Error revert (Property 3)
  ...
  - [ ]* 5.4 Write property test: Keyboard column navigation (Property 4)
  ...
  - [ ]* 5.5 Write property test: Screen reader announcements contain context (Property 5)
  ...
  - [ ]* 5.6 Write unit tests for DroppableColumn and DraggableLeadCard
  ...
  - [ ]* 5.7 Write integration tests for persistence and error handling
